...
const SignUp: React.FC<Props> = ({onCancel}) => {
        ...
        <div className={classes.container}>
            ...
            <form key={'form'} onSubmit={handleSubmit(onSubmit)}>
                ...
                <Grid container alignItems="center" justify="center">
                    ...
                    <Typography gutterBottom variant='h6' component='h6'>Already have an account? <span className={classes.linkGreen}> Sign In</span></Typography>
                </Grid>
            </form>
            {showSnackBar && (
                <SnackBar
